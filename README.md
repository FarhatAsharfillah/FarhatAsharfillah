...
I am an Information Technology undergraduate with a dual focus on Full-Stack Development and Artificial Intelligence. I specialize in building scalable web architectures, engineering robust RESTful APIs, and developing predictive Machine Learning and Computer Vision models to solve complex, data-driven problems.

### 🛠 Tech Stack
* **AI & Data Science:** Python, TensorFlow, OpenCV, Scikit-learn, XGBoost, YOLOv11, Pandas, NumPy
* **Backend & Core:** Node.js, Express.js, Java (Spring Boot), C++
* **Frontend & Mobile:** React, JavaScript, HTML
* **Database & Cloud:** PostgreSQL, MySQL, Aiven, Vercel, Render
* **Tools & Methodologies:** Git/GitHub, Postman, RESTful Architecture, SMOTE, Prompt Engineering (GenAI)
